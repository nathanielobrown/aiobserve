...
//! reads enrichable items out and writes accepted answers back, and the screen every model
//! answer passes before a row is written. `src/hyphae/enrich/` stays the authority for
